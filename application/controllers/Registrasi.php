...
class Registrasi extends CI_Controller {
  ...
  public function __construct(){
    ...
    $this->form_validation->set_rules(
      'username', 'Username', 'required|alpha_dash|is_unique[user.nama]',
      array(
    ...
    $this->form_validation->set_rules(
      'confirm_password', 'Password Confirmation', 'required|matches[password]',
      array(
        'required' => 'tidak boleh kosong',
    ...
    $this->form_validation->set_rules(
      'email', 'Email', 'required|valid_email|is_unique[user.email]',
      array(
        'required' => 'tidak boleh kosong',
        'is_unique' => 'sudah terdaftar',
    ...
    public function daftar_baru($data) {
		  return $this->model_registrasi->daftar_baru($data);
		}
